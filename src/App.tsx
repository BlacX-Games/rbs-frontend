 ...
 * densities resolve, and nothing reaches for a hex literal. Stages 2a and 2b-i
 * add the form, action, overlay, and navigation primitives below it, so one
 * page now shows the whole design system in every state.
 *
...
export function App() {
  return (
    /*
      Both providers are app-level, not gallery-level: Tooltip shares hover
      timing across every trigger beneath it, and Toast has to outlive whichever
      screen raised the message. Phase 2 hoists them to the router root, where
      they belong once one exists.
    */
    <ToastProvider closeLabel="Dismiss notification" viewportLabel="Notifications">
      <TooltipProvider>
        {/*
            ...
            <Section title="Typography">
              <div className="flex flex-col gap-16">
                ...
                <p className="font-mono text-base">
                  JetBrains Mono &mdash; 0O1lI &middot; a3f9c2b7
                </p>
